...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Chicken Fried Rice')
        r2 = create_recipe(user=self.user, title='Noodles')
    ...
    def test_filteer_by_ingredients(self):
        '''Test filtering recipes by ingredients'''
        r1 = create_recipe(user=self.user, title='Chicken Fried Rice')
        r2 = create_recipe(user=self.user, title='Noodles')

        in1 = Ingredients.objects.create(user=self.user, name='Rice')
        in2 = Ingredients.objects.create(user=self.user, name='noodle')
